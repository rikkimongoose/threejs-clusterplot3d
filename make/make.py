...
def combine_files():
	js_files = [
		...
		"src/external/fonts/droid_sans_bold.typeface.js",
		"src/external/fonts/droid_sans_mono_regular.typeface.js",
		"src/external/fonts/droid_sans_regular.typeface.js",
		"src/external/fonts/droid_serif_bold.typeface.js",
		"src/external/fonts/droid_serif_regular.typeface.js",
		...
		"src/external/THREEx.Plot3dColors.js",
		"src/external/THREEx.Plot3d.js",
	]
	...
	for js_file_name in js_files:
		if not os.path.exists(filename):
			...
			continue
		with open(js_file_name, "r") as js_file: js_text += js_file.read() + "\n"
